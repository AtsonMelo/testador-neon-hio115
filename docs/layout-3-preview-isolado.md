...
- area central com comandos demonstrativos desabilitados e painel industrial de
  4 DO / 8 DI;
...
O conteudo usa colunas proporcionais, largura e altura minimas e `AutoScroll`
para manter as zonas acessiveis em resolucoes menores. A composicao foi ajustada
para 1280x720, 1366x768 e 1920x1080 sem depender de comandos reais.
...
- os botoes centrais ficam desabilitados e sem eventos de comando;
